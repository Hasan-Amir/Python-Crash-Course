...
places = ["America", "Europe", "France", "Itally"]
print(f"Places sorted: {sorted(places)}")
print(f"Places sorted reverse: {sorted(places, reverse = True)}")
places.reverse()
print(f"Places reversed:", places)
places.reverse()
print(f"Places reversed again:", places)
places.sort()
print("Places sorted alphabetically:", places)
places.sort(reverse = True)
print("Places sorted reverse alphabetically:", places)
